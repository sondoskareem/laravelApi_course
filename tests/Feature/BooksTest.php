...
class BooksTest extends TestCase
    {
        ...
        */
        ...
        it_returns_all_books_as_a_collection_of_resource_objects()
        {
            ...
            publication_year,'created_at' => $books[0]->created_at->toJSON(),
...
it_can_sort_books_by_title_through_a_sort_query_parameter()
{
    ...
    $this->get('/api/v1/books?sort=title', [
        'accept' => 'application/vnd.api+json',
        'content-type' => 'application/vnd.api+json',])->assertStatus(200)->assertJson([
        "data" => [
        [
                "id" => '3',
                "type" => "books",
...
*/
    ...
    */
    ...
    ()
    {
        ...
        'last' => route('books.index', ['page[size]' => 5, 'page
        [number]' => 2]),
        'prev' => route('books.index', ['page[size]' => 5, 'page
        [number]' => 1]),
        'next' => null,
        ]
        ]);
...
*/
    ...
    */
    ...
    it_validates_that_the_type_member_has_the_value_of_books_when_creating_an_book
    ()
    {
        $user = factory(User::class)->create();
        Passport::actingAs($user);
    ...
    */
    public function
    it_validates_that_the_attributes_member_is_an_object_given_when_creating_an_book
    ()
    {
        $user = factory(User::class)->create();
        Passport::actingAs($user);
    ...
    */
    public function
    it_validates_that_a_publication_year_attribute_is_given_when_creating_an_book
    ()
    {
        $user = factory(User::class)->create();
        Passport::actingAs($user);
...
*/
    public function
    it_validates_that_a_publication_year_attribute_is_string_when_creating_an_book
    ()
    {
        $user = factory(User::class)->create();
        Passport::actingAs($user);
    ...
    */
    public function
    it_validates_that_a_publication_year_attribute_is_a_string_when_creating_an_book
    ()
        {
            $user = factory(User::class)->create();
            Passport::actingAs($user);
