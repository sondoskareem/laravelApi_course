...
*/
public function
a_relationship_link_to_books_returns_all_related_books_as_resource_id_objects
()
    {
        $author = factory(Author::class)->create();
        $books = factory(Book::class, 3)->create();
...
()
    {
        ...
        $user = factory(User::class)->create();
        Passport::actingAs($user);$this->patchJson('/api/v1/authors/1/relationships/books',[
            'data' => [
            [
            'id' => '5',
            'type' => 'books',
